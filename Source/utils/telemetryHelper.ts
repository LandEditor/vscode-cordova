...
export class TelemetryHelper {
	...
	public static prepareProjectTypesTelemetry(
		...
		const relevantProjectTypes: Partial<ProjectType> = Object.entries(
			projectType,
	...
	public static generate<T>(
		...
		codeGeneratingTelemetry: {
			(telemetry: TelemetryGenerator): Promise<T>;
		},
	): Promise<T> {
	...
	public static sendPluginsList(
		...
		const pluginDetails: IPluginDetails[] = newPlugins
			.map((pluginName) =>
				CordovaProjectHelper.getInstalledPluginDetails(
					projectRoot,
					pluginName,
				),
			)
